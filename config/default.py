...
POSTGRES_CONN_STRING = "postgresql+psycopg2://admin:1@localhost:5432/dkmh"  # This is for Airflow DB    # For localhost:  "postgresql+psycopg2://admin:1@localhost:5432/dkmh"
